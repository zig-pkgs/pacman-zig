...
int dload_progressbar_enabled(void)
{
...
void init_total_progressbar(void)
{
...
void dload_init_event(const char *filename, alpm_download_event_init_t *data)
{
	(void)data;
...
void dload_progress_event(const char *filename, alpm_download_event_progress_t *data)
{
	int index;
...
/* download retried */
void dload_retry_event(const char *filename, alpm_download_event_retry_t *data) {
	if(!dload_progressbar_enabled()) {
		return;
	}
...
/* download completed */
void dload_complete_event(const char *filename, alpm_download_event_completed_t *data)
{
	int index;
	struct pacman_progress_bar *bar;
	bool ok;
