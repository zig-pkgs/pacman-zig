...
pub fn translate(self: *Config) !void {
    const gpa = self.getParent().gpa;
    c.config = try gpa.create(c.config_t);
...
pub fn initAlpm(self: *Config) !void {
    ...
    _ = c.alpm_option_set_logcb(handle, callbacks.cb_log, null);
    _ = c.alpm_option_set_dlcb(handle, callbacks.cb_download, null);
    _ = c.alpm_option_set_eventcb(handle, c.cb_event, null);
    _ = c.alpm_option_set_questioncb(handle, c.cb_question, null);
    _ = c.alpm_option_set_progresscb(handle, c.cb_progress, null);
